...
such as raising a heavy weight, turning a winch, or removing an obstacle.[^4] In such cases the effect of the combined labour could either not be produced at all by isolated individual labour, or it
...
could be if each man went separately up and down the ladder with his burden.[^8] The object is carried over the same distance in a shorter time. Again, a combination of labour occurs whenever a building,
...
isolated labourers required to do the same amount of work in the same period.[^10] It is owing to the
...
the gigantic structures of the ancient Asiatics, Egyptians, Etruscans, &amp;c.
...
which feed them, to one or a few hands, which makes such undertakings possible.&#8221;[^19]
